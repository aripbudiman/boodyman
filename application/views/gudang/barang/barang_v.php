...
<div class="row">
    <div id="barang_dt" class="col-md-8"><?php $this->load->view('gudang/barang/barang_dt_v') ?></div>
    <div id="barang_fm" class="col-md-4"><?php $this->load->view('gudang/barang/barang_fm_v') ?></div>
</div>
