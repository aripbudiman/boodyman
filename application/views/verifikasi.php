  ...
  <body style="background-color: #9ecfdb;">
    <div class="login-box coy" align="center"> 
      ...
      <?php echo $this->session->flashdata('msg'); ?>
        ...
        <form method="post" action="<?php echo base_url() ?>Log/send_email">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Email Terdaftar" name="email" autofocus>
          </div>
          ...
          <div class="row">
            <div class="col-xs-4">
             ...
             <div class="col-xs-4">
              <a href="<?php echo base_url() ?>" class="btn  bg-navy btn-block btn-flat"> <i class="fa  fa-rotate-right"></i> &nbsp;  Batal</a>
            </div><!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-info btn-block btn-flat"><i class="fa fa-sign-in"></i> &nbsp;  Kirim</button>
            </div><!-- /.col -->
          </div>
        </form>   
      </div><!-- /.login-box-body -->
