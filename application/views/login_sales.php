    ...
    <div class="login-box coy" align="center"> 
      <div class="login-box-body" style="border-radius: 7px;">
          <!--img width="50px" src="<?php //echo base_url() ?>assets/img/favicon.png"><br-->
        	<span style="font-size:22px;color: #029acf;font-family: arial;"><b> Sistem </b></span><span style="font-size:22px;color: #d2d6de; font-family: verdana;">Inventory </span><br><br>
        
      
      <?php echo $this->session->flashdata('msg'); ?>
        <!--p class="login-box-msg" style="font-size:18px;">Login Admin</p-->
        
        <form method="post" action="<?php echo base_url() ?>Sales/auth">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" required  id="username" placeholder="User " name="user" autofocus>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" class="btn btn-info btn-block btn-flat"><i class="fa fa-sign-in"></i> &nbsp;  Masuk</button>
            </div><!-- /.col -->
          </div>
        </form>   
      </div><!-- /.login-box-body -->
      <div class="text-right"><a href="<?php echo base_url() ?>verifikasi"><i style="font-color:#000">Verifikasi Akun Sales</i></a></div>
    </div><!-- /.login-box -->
