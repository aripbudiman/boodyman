...
<div class="row">
    <div id="lap_hari" class="col-md-4"><?php $this->load->view('pimpinan/lap-masuk/masuk_hari') ?></div>
    <div id="lap_bulan" class="col-md-4"><?php $this->load->view('pimpinan/lap-masuk/masuk_bln') ?></div>
    <div id="lap_thn" class="col-md-4"><?php $this->load->view('pimpinan/lap-masuk/masuk_thn') ?></div>
</div>
